...
1. Install patched nerd fonts (Hack).
   - Download the latest Hack Nerd Font from [ryanoasis nerd-fonts git](https://github.com/ryanoasis/nerd-fonts) $\rightarrow$ [Releases](https://github.com/ryanoasis/nerd-fonts/releases) $\rightarrow$ [Hack.zip](https://github.com/ryanoasis/nerd-fonts/releases/download/v3.3.0/Hack.zip).
